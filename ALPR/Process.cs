...
namespace ALPR
{
    public class Process
    {
        ...
        public Process()
        {
            _directory = "C:\\Users\\alvaroa\\Desktop\\image";
            _allowedExtensions = new List<string> { ".jpg", ".png", ".gif" };
            _assetsFolder = "C:\\Users\\alvaroa\\Desktop\\ultimateALPR-SDK-master\\assets";
            _charset= "latin";
        }

        public void Run()
        {
            List<string> imageFiles = GetFiles(_directory, _allowedExtensions);

            foreach (string file in imageFiles)
            {
                //UltAlprSdkResult result = CheckResult("Init", UltAlprSdkEngine.init(BuildJSON(_charset, _assetsFolder, string.Empty)));
